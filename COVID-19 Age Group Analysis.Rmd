...
The dataset that I will be using for this project is the covid-19 dataset that's available on the [**Open Toronto Website**](https://open.toronto.ca) website, specifically [**COVID 19 CASES**](https://open.toronto.ca/dataset/covid-19-cases-in-toronto/), which can be downloaded from this [**link**](https://ckan0.cf.opendata.inter.prod-toronto.ca/dataset/64b54586-6180-4485-83eb-81e8fae3b8fe/resource/fff4ee65-3527-43be-9a8a-cb9401377dbc/download/COVID19%20cases.csv) and can and I will conduct the statistical analysis as follows
...
url <- "https://ckan0.cf.opendata.inter.prod-toronto.ca/dataset/64b54586-6180
-4485-83eb-81e8fae3b8fe/resource/fff4ee65-3527-43be-9a8a-cb9401377dbc/download/
COVID19%20cases.csv"
